    ...
    def pipeline_actions():
        ...
        with (
            ui.button(
                "Escalations",
                icon="flag",
                on_click=lambda: ui.navigate.to("/pipeline/escalations"),
            )
            .classes("text-white")
            .props("flat dense")
        ):
...
@ui.page("/pipeline/escalations")
def pipeline_escalations_page():
    ...
    render_header(viewer_id, active_phase=2, right_slot=escalation_actions)
