...
Usage:
    uv run python -m pipeline.phase4 submit --run reflections [overrides...]
    uv run python -m pipeline.phase4 status --run reflections
    uv run python -m pipeline.phase4 merge  --run reflections
    uv run python -m pipeline.phase4 rerun  --run reflections [overrides...]
"""
...
def cmd_status(args, overrides):
    ...
    from pipeline.phase4.progress import get_run_progress
