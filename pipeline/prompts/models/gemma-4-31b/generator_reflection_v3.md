...
- Cite 3.1/3.2/3.3/3.6 only when sincerity, evidence quality, the fact-vs-speculation boundary, or licensed-professional advice is genuinely a prominent feature — not for a casual fact, link, correction, single hedge word, or offhand joke.
- Harm values: 5.1 = actionable steps for harm, or glorifying/encouraging harm or harmful illegal activity — state plainly why it is harmful when you cite it; 5.3 = responding to someone in crisis; 5.2 = a vulnerable population. Do not cite 5.x for careless or wrong advice, edgy jokes or memes, neutral analysis or news of violence, a passing mention of danger, or concern about someone.
