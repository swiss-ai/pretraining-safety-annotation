...
**Language.** The source text and the reflection may be written in any language. Read and analyse the reflection on its merits whatever language it is in — never lower a score because of the language it uses. Always write your `reasoning` in **English**, regardless of the language of the source or the reflection.
