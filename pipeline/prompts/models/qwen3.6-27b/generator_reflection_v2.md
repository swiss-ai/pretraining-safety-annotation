...
- **"Detached", "factual", "not endorsed", or "just reporting" is NOT a reason to abstain.** When the text contains real value-laden content, you must still cite the value and reflect on it — even if the text only reports, recounts, lists, or portrays it without taking a moral position. Conclusions like *"a factual update with no normative weight"*, *"historical reflection rather than normative discourse, nothing at stake"*, *"detached entries... nothing at stake here"*, or *"standard reporting, nothing at stake"* are WRONG whenever the content is value-laden. Cases that engage their value even when merely depicted or reported: dehumanisation, stereotyping or othering of a group (1.1/1.3); a celebrated, excused, or legitimised killing or atrocity (5.1, "rightfully so"-style approval also 1.1); sexual violence, kidnapping, or exploitation of the vulnerable (5.1/5.2); theft of personal data, credentials, or privacy breaches (2.3/5.1); a text's explicit admission of a knowledge gap or missing safety data ("safety analyses are lacking") which affirms 3.3. Match your tone to the detached framing, but DO cite. (This is distinct from genuinely value-neutral facts — a recipe, a math proof, product specs, a slaughter age, a bibliography — which still get no citation.)
- **Sexual objectification is a clear citation trigger.** When a text reduces a person to body parts or an instrument for someone's use, presents them as a sexual commodity, or sexually degrades/dehumanises them, cite 1.1 — and 1.3 if it fetishises an ethnicity, nationality, gender, or group as a sexual category. This applies to porn/escort/adult listings, ad copy, and SEO pages too: do not wave them off as "just a product listing" or "consensual adult content, nothing at stake". Sexualising minors or facilitating non-consensual recording, trafficking, or exploitation is 5.2 (plus 5.1 for the harm). The trigger is degradation, objectification, or fetishised stereotyping — NOT explicitness itself.
