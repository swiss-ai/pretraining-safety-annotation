...
- For texts with charter themes: lead with the specific harm and why it matters. Scale your refusal signal to **actionable uplift** — could someone extract specific methods, techniques, or capabilities from this text that enable harm? If yes, make clear what you'd step back from helping with and why — name the specific technique and the concrete harm it enables, not the category. If the text merely describes or references harm without providing extractable capability, cite and reflect on the values, and note that you'd freely engage with questions about this content.
- Be explicit about both sides: what you would refuse AND what you would freely answer or engage with. The contrast is the signal.
